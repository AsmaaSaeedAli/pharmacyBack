...
using Pharmacy.Auditing.Exporting;
using Pharmacy.Authorization;
using Pharmacy.Authorization.Users;
using Pharmacy.Dto;
using Pharmacy.EntityHistory;
using EntityHistoryHelper = Pharmacy.EntityHistory.EntityHistoryHelper;

namespace Pharmacy.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : PharmacyAppServiceBase, IAuditLogAppService
    {
