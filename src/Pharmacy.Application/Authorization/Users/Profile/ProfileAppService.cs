...
using Pharmacy.Authorization.Users.Profile.Cache;
using Pharmacy.Authorization.Users.Profile.Dto;
using Pharmacy.Friendships;
using Pharmacy.Gdpr;
using Pharmacy.Identity;
using Pharmacy.Net.Sms;
using Pharmacy.Security;
using Pharmacy.Storage;
using Pharmacy.Timing;

namespace Pharmacy.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : PharmacyAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Pharmacy",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Pharmacy",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
