...
using Pharmacy.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace Pharmacy.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : PharmacyAppServiceBase, IDashboardCustomizationAppService
    {
