...
using Pharmacy.DemoUiComponents.Dto;

namespace Pharmacy.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : PharmacyAppServiceBase, IDemoUiComponentsAppService
    {
