...
namespace Pharmacy.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : PharmacyAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<PharmacyDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(PharmacyConsts.ConnectionStringName).Value.ToString();
        }
