...
{
    public class AppInvoiceAppService : PharmacyAppServiceBase, IAppInvoiceAppService
    {
        ...
        public async Task<AppInvoiceDto> GetInvoiceInfo(EntityDto<long> input)
        {
