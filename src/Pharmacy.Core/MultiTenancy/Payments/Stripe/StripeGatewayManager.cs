...
{
    public class StripeGatewayManager : PharmacyServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Pharmacy";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + PharmacyConsts.Currency;
        }
        ...
        private async Task<StripeIdResponse> CreatePlanAsync(string planId, decimal amount, string interval, string productId)
        {
            ...
            var plan = await planService.CreateAsync(new PlanCreateOptions
            {
                ...
                Interval = interval,
                Product = productId,
                Currency = PharmacyConsts.Currency
            });
