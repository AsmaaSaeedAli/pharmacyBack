...
namespace Pharmacy.Migrations
{
    ...
    [Migration("20200908065507_Update_ItemClass_ItemNumberStart")]
    partial class Update_ItemClass_ItemNumberStart
    {
            ...
            modelBuilder.Entity("Pharmacy.Items.ItemPrice", b =>
                {
                    ...
                    b.HasOne("Pharmacy.Corporates.Corporate", "Corporate")
                        .WithMany()
                        .HasForeignKey("CorporateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
