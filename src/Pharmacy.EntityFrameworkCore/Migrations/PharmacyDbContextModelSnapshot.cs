...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pharmacy.Address.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Address.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Address.Region", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Branches.Branch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Categories.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Categories.GeneralCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Corporates.Corporate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Customers.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("NoOfDependencies")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pharmacy.Employees.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Invoices.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Invoices.InvoiceItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.ItemClasses.ItemClass", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ItemNumberStart")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pharmacy.Items.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("CorporateFavoriteId")
                        .HasColumnType("int");
                  ...
                  //  b.Property<int?>("ManufactureId")
                   //     .HasColumnType("int");
                    ...
                    b.Property<int?>("PreferedStockId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CorporateFavoriteId");
            ...
            modelBuilder.Entity("Pharmacy.Items.ItemBarCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Items.ItemPrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Items.ItemQuantity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Jobs.Job", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("MaxNoOfPositions")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pharmacy.Lookups.Lookup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Lookups.LookupType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pharmacy.ManuFactories.ManuFactory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Pharmacy.SubCategories.SubCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Address.City", b =>
                {
                    b.HasOne("Pharmacy.Address.Region", "Region")
                        .WithMany()
                        .HasForeignKey("RegionId");

                    b.OwnsOne("Shared.SeedWork.LocalizedText", "Name", b1 =>
                        {
            ...
            modelBuilder.Entity("Pharmacy.Address.Country", b =>
                {
                    b.HasOne("Pharmacy.Lookups.Lookup", "Currency")
                        .WithMany()
                    ...
                    b.OwnsOne("Shared.SeedWork.LocalizedText", "Nationality", b1 =>
                        {
                            b1.Property<int>("CountryId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Address.Region", b =>
                {
                    b.HasOne("Pharmacy.Address.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId");
            ...
            modelBuilder.Entity("Pharmacy.Branches.Branch", b =>
                {
                    b.HasOne("Pharmacy.Lookups.Lookup", "BranchType")
                        .WithMany()
                        .HasForeignKey("BranchTypeId");

                    b.HasOne("Pharmacy.Address.City", "City")
                        .WithMany()
                        .HasForeignKey("CityId");
            ...
            modelBuilder.Entity("Pharmacy.Categories.Category", b =>
                {
                    b.HasOne("Pharmacy.ItemClasses.ItemClass", "ItemClass")
                        .WithMany()
                        .HasForeignKey("ItemClassId");

                    b.OwnsOne("Shared.SeedWork.LocalizedText", "Description", b1 =>
                        {
            ...
            modelBuilder.Entity("Pharmacy.Categories.GeneralCategory", b =>
                {
                    b.OwnsOne("Shared.SeedWork.LocalizedText", "Name", b1 =>
                        {
                            b1.Property<int>("GeneralCategoryId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
                                .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                            ...
                            b1.HasKey("GeneralCategoryId");

                            b1.ToTable("GeneralCategories");
                    ...
                    b.OwnsOne("Shared.SeedWork.LocalizedText", "Name", b1 =>
                        {
                            ...
                            b1.HasKey("CorporateId");

                            b1.ToTable("Corporates");
            ...
            modelBuilder.Entity("Pharmacy.Customers.Customer", b =>
                {
                    b.OwnsOne("Shared.SeedWork.LocalizedText", "FullName", b1 =>
                        {
            ...
            modelBuilder.Entity("Pharmacy.Employees.Employee", b =>
                {
                    b.HasOne("Pharmacy.Branches.Branch", "Branch")
                        .WithMany()
                        .HasForeignKey("BranchId");

                    b.HasOne("Pharmacy.Lookups.Lookup", "Gender")
                        .WithMany()
                        .HasForeignKey("GenderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pharmacy.Address.Country", "Nationality")
                        .WithMany()
                    ...
                    b.OwnsOne("Shared.SeedWork.LocalizedText", "Name", b1 =>
                        {
                            ...
                            b1.HasKey("ItemClassId");

                            b1.ToTable("ItemClasses");
            ...
            modelBuilder.Entity("Pharmacy.Items.Item", b =>
                {
                    b.HasOne("Pharmacy.Categories.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pharmacy.Corporates.Corporate", "CorporateFavorite")
                        .WithMany()
                        .HasForeignKey("CorporateFavoriteId");
                    ...
                    b.HasOne("Pharmacy.ManuFactories.ManuFactory", "ManuFactory")
                        .WithMany()
                        .HasForeignKey("ManuFactoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pharmacy.SubCategories.SubCategory", "SubCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("Pharmacy.Items.ItemPrice", b =>
                {
                    b.HasOne("Pharmacy.Items.Item", "Item")
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pharmacy.Items.ItemQuantity", b =>
                {
                    ...
                    b.HasOne("Pharmacy.Items.ItemPrice", "ItemPrice")
                        .WithMany()
                        .HasForeignKey("ItemPriceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pharmacy.Lookups.Lookup", "Unit")
                        .WithMany()
                    ...
                    b.OwnsOne("Shared.SeedWork.LocalizedText", "Name", b1 =>
                        {
                            ...
                            b1.HasKey("LookupTypeId");

                            b1.ToTable("LookupTypes");
                    ...
                    b.OwnsOne("Shared.SeedWork.LocalizedText", "Name", b1 =>
                        {
                            ...
                            b1.HasKey("ManuFactoryId");

                            b1.ToTable("ManuFactories");
