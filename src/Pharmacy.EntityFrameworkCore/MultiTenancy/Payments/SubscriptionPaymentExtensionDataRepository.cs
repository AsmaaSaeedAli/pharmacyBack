...
using Pharmacy.EntityFrameworkCore.Repositories;

namespace Pharmacy.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : PharmacyRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<PharmacyDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
