...
{
    public class SubscriptionPaymentRepository : PharmacyRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<PharmacyDbContext> dbContextProvider)
