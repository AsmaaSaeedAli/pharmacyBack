...
using MvvmHelpers;
using DemoDemo.Authorization.Users.Profile;
using DemoDemo.Authorization.Users.Profile.Dto;
using DemoDemo.Commands;
using DemoDemo.Core.Threading;
using DemoDemo.Models.NavigationMenu;
using DemoDemo.Services.Navigation;
using DemoDemo.ViewModels.Base;
using Plugin.Media;
...
using DemoDemo.ApiClient;
using DemoDemo.Controls;
using DemoDemo.Dto;
using DemoDemo.Extensions;
using DemoDemo.Localization;
using DemoDemo.UI;
using DemoDemo.UI.Assets;
using DemoDemo.Views;
using DependencyResolver = DemoDemo.Core.Dependency.DependencyResolver;
...
namespace DemoDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "DemoDemo";
