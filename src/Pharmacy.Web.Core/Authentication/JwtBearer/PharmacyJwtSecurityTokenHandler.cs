...
namespace Pharmacy.Web.Authentication.JwtBearer
{
    public class PharmacyJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public PharmacyJwtSecurityTokenHandler()
        {
