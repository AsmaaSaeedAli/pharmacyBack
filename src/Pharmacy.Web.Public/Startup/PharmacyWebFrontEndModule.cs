...
namespace Pharmacy.Web.Public.Startup
{
    [DependsOn(
        typeof(PharmacyWebCoreModule)
    )]
    public class PharmacyWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public PharmacyWebFrontEndModule(IWebHostEnvironment env, PharmacyEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PharmacyWebFrontEndModule).GetAssembly());
        }
    }
}
