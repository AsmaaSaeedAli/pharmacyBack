...
using Pharmacy.Url;
using Pharmacy.Web.Public.Startup;
using Pharmacy.Web.Session;

namespace Pharmacy.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : PharmacyViewComponent
    {
