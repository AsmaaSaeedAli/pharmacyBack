...
using Pharmacy.MultiTenancy.HostDashboard;
...
namespace Pharmacy.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(PharmacyDbContext context, SubscriptionPayment subscriptionPayment)
        {
